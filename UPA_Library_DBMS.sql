...
--4.List the details of all current book reservations. The list should include member IDs and names, book IDs and titles as well as the status of each book (i.e. it is ‘available’ or ‘loaned out’) reserved.
...
--5.For each department, list the department names, the total number of books borrowed by its students and the total number of books borrowed by its staff.
...
--6.List all details of all members who have borrowed any books written by the author named ‘C.J. Date’.
...
--7.List the titles of all ‘Computing’ books published by ‘Prentice Hall’ (i.e. publisher) in the year 2019.
...
--8.List in ascending order of department names, then in alphabetical order of member names, the details of all ‘inactive’ members.
...
--9.For each member with overdue books, list their IDs, names, the book IDs and titles of overdue books as well as the fines incurred for each of those books. 
...
--10.List the IDs and names of all members who have borrowed at least 5 books.
...
--11.List in alphabetical order, the names of all publishers of books from either the ‘red-tagged’ or ‘yellow-tagged’ categories.
...
--12.List the member IDs, member names, book title and the publisher names for all members who had borrowed any books containing the word ‘Databases’ in its title.
